...
public class Lab1//I refactor class name from lab1_1 to Lab1. It may cause you can't use git diff. But I think we should have this changed.
{
	...
	public static void main(String[] args)
	{
		...
		while (Integer.parseInt(line1_1[0]) == 0)
		{
			...
			case "1": // ! simplify
				...
				break;
			case "2":// !d/d var
				String str = derivative(line1_1[1], line1_2[1]);
	 ...
	 * @param word
	 */
	public static String derivative(String line, String word)
	{
		...
		else
		{
			if (strs3[0][1] == null)
			{
				str = str + "求导结果为：" + strs3[0][0];
			}
			else
			{
				str = str + "求导结果为：" + strs3[0][0] + "*" + strs3[0][1];
			}
